    	...
    	if(cond instanceof NoRestriction){
    		...
    		if(name.equalsIgnoreCase("id")){
    			if(value instanceof IntNumberValue){    				
    				return testBinary((BinaryCondition)cond, ((IntNumberValue) value).getValue(), e.getId());
    			}else{
    				return false;
    			}
    		}else if(name.equalsIgnoreCase("outdegree")){
    			if(value instanceof IntNumberValue && e instanceof Vertex){    				
    				return testBinary((BinaryCondition)cond,((IntNumberValue) value).getValue(),IterableHelper.count(((Vertex)e).getOutEdges()));
    			}else{
    				return false;
    			}
    		}else if(name.equalsIgnoreCase("indegree")){
    			if(value instanceof IntNumberValue && e instanceof Vertex){    				
    				return testBinary((BinaryCondition)cond,((IntNumberValue) value).getValue(),IterableHelper.count(((Vertex)e).getInEdges()));
    			}else{
    				return false;
    			}
    		}else if(name.equalsIgnoreCase("degree")){
    			if(value instanceof IntNumberValue && e instanceof Vertex){    				
    				return testBinary((BinaryCondition)cond,((IntNumberValue) value).getValue(),IterableHelper.count(((Vertex)e).getEdges()));
    			}else{
    				return false;
    			}
    		}else{
    			...
    			if(value instanceof IntNumberValue){
    				return testBinary((BinaryCondition)cond,((IntNumberValue) value).getValue(), ByteArrayHelper.parseInt(data));
    			}else if(value instanceof StringValue){
    				return testBinary((BinaryCondition)cond,((StringValue) value).getValue(),ByteArrayHelper.parseString(data));
    			}else{
